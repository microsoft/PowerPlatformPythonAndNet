...
> **Note**: This is the *id* of the *Shopping* list that you created in [Lab 2](https://github.com/dikodev/PowerPlatformPythonAndNet/tree/main/Python/Lab2#step-2---add-your-own-list-data).
...
### Next: [Lab 5 - Creating a Power Apps Canvas App](/Python/Lab5/)
